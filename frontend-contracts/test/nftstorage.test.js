...
describe("LazyNFT", function () {
  ...
  it("Should redeem an NFT from a signed voucher", async function () {
    ...
    console.log("voucher cid",meta)
    await expect(redeemerContract.redeem(redeemer.address, voucher, meta, signature))
  ...
  it("Should make payments available to minter for withdrawal", async function () {
    ...
    await expect(
      await redeemerContract.redeem(redeemer.address, voucher,  meta,signature, {
        value: minPrice,
      })
